...
if(isset($_POST['simpan'])){
    ...
    $solusi=$_POST['solusi'];
	    ...
	    //proses simpan kasus
        $sql = "INSERT INTO kasus VALUES (Null,'$idkerusakan','$solusi')";
        mysqli_query($conn,$sql);

        // mengambil idgejala
        $idgejala=$_POST['idgejala'];

        // proses mengambil data kasus
        $sql = "SELECT * FROM kasus ORDER BY idkasus DESC";
        $result = $conn->query($sql);
        $row = $result->fetch_assoc();
        $idkasus=$row['idkasus'];

        //proses simpan detail kasus
    ...
    <div class="col-sm-12">
        <form action="" method="POST" name="Form" onsubmit="return validasiForm()">
            <div class="card border-dark">
                <div class="card">
                <div class="card-header bg-primary text-white border-dark"><strong>Tambah Data Kasus</strong></div>
                <div class="card-body">
